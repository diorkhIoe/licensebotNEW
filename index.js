...
client.on('message', message => {
	...
	//  only owner
	if (comid.admin && message.author.id !== owner )return message.reply("Only nick can access this command!");

	// only on nsfw channel
	if (comid.nsfw && !message.channel.nsfw) return message.reply("This command needs to be sent in an NSFW channel.")
